...
<head>
    ...
    <link rel="icon" type="image/png" href="https://th.bing.com/th/id/R.2ebc6c77ba84d7194d4a8f6a7334571e?rik=2ffoY4RHjXWJ2w&pid=ImgRaw&r=0">
...
<body>
                ...
                <ul>
                    ...
                    <button class="user-container" id="myButton">
                        <div class="user-fame" style="width: 28px; height:28px; inset-inline-start: 0px;">
                            <div class="user-icon">
                                <svg role="img" height="16" width="16" aria-hidden="true" viewBox="0 0 16 16" data-encore-id="icon" class="Svg-sc-ytk21e-0 gQUQL" style="fill: #ffffff;">
                        ...
                        <svg role="img" height="16" width="16" aria-hidden="true" class="Svg-sc-ytk21e-0 gQUQL eAXFT6yvz37fvS1lmt6k user-svg" viewBox="0 0 16 16" data-encore-id="icon">
                            <path d="m14 6-6 6-6-6h12z"></path>
                        </svg>
                        <div id="myDiv" class="hidden">
                            <p>Profile</p>

                            <p style="border-top: 0.5px  solid #7e7878" onclick="window.location='{{ route('logout.perform') }}'">Log out</p>
                        </div>
                    </button>
            </div>
            @endauth
    ...
    <div class="music-player">
        <div class="song-bar">
            ...
            <div class="icons">
                @auth
                <i id="heart-{{ $song->id }}" class="{{ $song->likes->where('User_id', auth()->user()->id)->contains('Song_id', $song->id) ? 'fas fa-heart' : 'far fa-heart' }}" onclick="toggleLike({{ $song->id }})"></i>
                @endauth
                @guest
        ...
        <div class="progress-controller">
            <div class="control-buttons">
                ...
                <i class="play-pause fas fa-play" title="play" onclick="playpauseTrack()" style="line-height: 0.9;"></i>
            ...
            <div class="progress-container">
                ...
                <input type="range" min="0" max="1" step="0.01" value="0" class="progress-bar" onchange="seekTo()" onmousedown="startSeek()" onmouseup="endSeek()" name="" id="slider">
        ...
        <div class="other-features">
            ...
            <div class="volume-bar">
                ...
                <input type="range" min="0" max="1" step="0.01" value="1" class="volume-slider progress-bar" onchange="adjustVolume()" id="volume-slider">
            </div>
