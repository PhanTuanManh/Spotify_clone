        ...
        <div class="spotify-playlists">
            ...
            <article>
                ...
                <div class="container-edit">
                    <a href="{{ route('profile.edit', ['id' => auth()->user()->User_id]) }}"
                        class="profile-edit">Edit profile</a>
                </div>
            </article>
            <h4></h4>
        </div>
                        ...
                        <div class="w-row">
                            <div class="w-col w-col-7 w-col-small-6 w-col-tiny-7">
                                ...
                                <p class="footer-links"><a href="" target="_blank"><span
                                        ...
                                        href=""><span class="footer-link">Blog</span></a><span><br></span><a
                                        href=""><span class="footer-link">Entrepreneurial
                                            Tools<br></span></a><a href=""><span class="footer-link">Startup
                                            Cemetery<br></span></a><a href=""><span
                            ...
                            <div class="w-col w-col-5 w-col-small-6 w-col-tiny-5">
                                ...
                                <p class="footer-links"><a href=""><span class="footer-link">Sponsor
                                            ...
                                            class="footer-link"></span></a><a href=""><span
                                            class="footer-link">Contribute<br></span></a><a href=""><span
